...
class ClicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create click" do
    assert_difference("Click.count") do
      post clicks_url, params: { click: { link_id: @click.link_id, user_id: @click.user_id } }
    end
  ...
  test "should update click" do
    patch click_url(@click), params: { click: { link_id: @click.link_id, user_id: @click.user_id } }
